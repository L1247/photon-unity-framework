...
[HelpURLAttribute("https://doc.photonengine.com/en-us/voice/current/getting-started/voice-for-pun#the__audio_source__prefab")]
public class PhotonVoiceRecorder : Photon.MonoBehaviour
{
    private Voice.LocalVoice voice = Voice.LocalVoiceAudio.Dummy;

    protected Voice.LocalVoiceAudioFloat voiceAudio { get { return (Voice.LocalVoiceAudioFloat)this.voice; } }
    ...
    public string MicrophoneDevice
    {
        ...
        set
        {
            ...
            if (this.voice != Voice.LocalVoiceAudio.Dummy && AudioClip == null)
            {
                ...
                this.voice = PhotonVoiceNetwork.CreateLocalVoice(voiceInfo, mic);
    ...
    {
        public Voice.LocalVoiceAudioFloat Voice;
        public Voice.VoiceInfo Info;
        public VoiceCreatedParams(Voice.LocalVoiceAudioFloat voice, Voice.VoiceInfo info)
        {
            Voice = voice;
            Info = info;
        }
